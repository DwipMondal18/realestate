                    ...
                    <div class="col-xl-8 order-xl-1 sm-mb-30">
                        <div class="single-post border summary bg-white p-30 mb-30">
                            ...
                            <div class="post-image">
                                <img src="<?=base_url();?>assets/images/property_grid/property-grid-8.png" alt="Image not found!">
                            </div>
                        ...
                        <div class="authore-meta bg-white mb-30">
                            <div class="modal-content border">
                                ...
                                <div class="modal-body d-flex">
                                    <div class="author-image"><img class="rounded-circle" src="<?=base_url();?>assets/images/user1.jpg" alt="image not found!"></div>

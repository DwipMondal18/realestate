            ...
            <div class="container">
                <div class="row">
                    <div class="col inner-page-banner">
                        <h3 class="text-secondary">Luann McLawhorn</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 bg-transparent p-0">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Agents</a></li>
                                <li class="breadcrumb-item active text-primary" aria-current="page">Luann McLawhorn</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-12 agent-style-1 list-view agent-details">
                        <div class="entry-wrapper bg-white transation-this hover-shadow mb-4">
                            <div class="entry-thumbnail-wrapper transation bg-secondary hover-img-zoom">
                                ...
                                <img src="<?=base_url();?>assets/images/team/1.jpg" alt="Agent Photo">
                            </div>
                            <div class="entry-content-wrapper">
                                <div class="entry-header d-flex pb-2">
                                    <div class="me-auto">
                                        <h6 class="agent-name text-dark mb-0"><a href="#">Luann McLawhorn</a></h6>
                                        <span class="text-primary font-fifteen">From 1st April, 2012</span>
                                    </div>
                                </div>
                                <div class="enrey-content">
                                    <p>Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscorem ipsum dolor sit ametcipsum dolor sit t, consec tetur atetur cing elit. Suspe ndisse susco rem ipsum dolor sit ametcipsum doloamet.</p>
                                    <ul class="agent-contact py-1">
                                        <li><span>Mobile:</span>891 456 9874</li>
                                        <li><span>Email:</span>pakulla@findhouse.com</li>
                                        <li><span>Website:</span><a href="#">www.websitename.com</a></li>
                                ...
                                <div class="entry-footer d-flex align-items-center post-meta py-2 border-top">
                                    <div class="agent">
                                        <a href="#" class="d-flex text-general align-items-center">
                                            <img class="rounded-circle mr-2" src="<?=base_url();?>assets/images/logo/1.png" alt="avata"><span>Company Name</span>
                                        </a>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 order-xl-2">
                        ...
                        <div class="widget widget_send_message mb-30">
                            <h5 class="mb-4">Luann McLawhorn</h5>
                    ...
                    <div class="col-xl-8 order-xl-1">
                        <div class="entry-wrapper">
                            ...
                            <div class="agent-properties">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-12">
                                        <div class="mix-tab">
                                            <ul class="d-table">
                                                <li data-filter="all">All Property (27)</li>
                                                <li data-filter=".sale">For Sale (10)</li>
                                                <li data-filter=".rent">For Rent (17) </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        <div class="tab-content bg-white px-30 py-5">
                                            <div class="mix-element row row-cols-lg-2 row-cols-md-2 g-4 row-cols-1">
                                                <!-- Property Grid -->
                                                <div class="col mix rent">
                                                    <div class="property-grid-2 property-block transation">
                                                        <div class="overflow-hidden position-relative transation thumbnail-img rounded bg-secondary hover-img-zoom">
                                                            <div class="cata position-absolute">
                                                                <span class="sale bg-secondary text-white">For Rent</span>
                                                            </div>
                                                            <a href="<?php echo base_url('property-single-v1/');?>" class="d-block"><img src="<?=base_url();?>assets/images/property_grid/property-grid-5.png" alt="Image Not Found!"></a>
                                                            <ul class="position-absolute quick-meta">
                                                                <li><a href="#" title="Add Compare"><i class="flaticon-transfer flat-mini"></i></a></li>
                                                                <li><a href="#" title="Add Favourite"><i class="flaticon-like-1 flat-mini"></i></a></li>
                                                                <li class="md-mx-none"><a class="quick-view" href="#quick-view" title="Quick View"><i class="flaticon-zoom-increasing-symbol flat-mini"></i></a></li>
                                                        ...
                                                        <div class="post-content py-3">
                                                            <div class="post-meta font-small text-uppercase list-color-general">
                                                                <a href="#" class="listing-ctg"><i class="fa-solid fa-building"></i><span>Villa</span></a>
                                                            </div>
                                                            <h5 class="listing-title"><a href="<?php echo base_url('property-single-v1/');?>">Gorgeous Villa Bay View</a></h5>
                                                            <span class="listing-location"><i class="fas fa-map-marker-alt"></i> 2305 Tree Frog Lane Overlandpk</span>
                                                ...
                                                <div class="col mix sale">
                                                    <div class="property-grid-2 property-block transation">
                                                        <div class="overflow-hidden position-relative transation thumbnail-img rounded bg-secondary hover-img-zoom">
                                                            <div class="cata position-absolute">
                                                                <span class="sale bg-extra text-white">For Sale</span>
                                                            </div>
                                                            <a href="<?php echo base_url('property-single-v1/');?>" class="d-block"><img src="<?=base_url();?>assets/images/property_grid/property-grid-6.png" alt="Image Not Found!"></a>
                                                            <ul class="position-absolute quick-meta">
                                                                <li><a href="#" title="Add Compare"><i class="flaticon-transfer flat-mini"></i></a></li>
                                                                <li><a href="#" title="Add Favourite"><i class="flaticon-like-1 flat-mini"></i></a></li>
                                                                <li class="md-mx-none"><a class="quick-view" href="#quick-view" title="Quick View"><i class="flaticon-zoom-increasing-symbol flat-mini"></i></a></li>
                                                ...
                                                <div class="col mix rent">
                                                    <div class="property-grid-2 property-block transation">
                                                        <div class="overflow-hidden position-relative transation thumbnail-img rounded bg-secondary hover-img-zoom">
                                                            ...
                                                            <a href="<?php echo base_url('property-single-v1/');?>" class="d-block"><img src="<?=base_url();?>assets/images/property_grid/property-grid-7.png" alt="Image Not Found!"></a>
                                                            <ul class="position-absolute quick-meta">
                                                                <li><a href="#" title="Add Compare"><i class="flaticon-transfer flat-mini"></i></a></li>
                                                                <li><a href="#" title="Add Favourite"><i class="flaticon-like-1 flat-mini"></i></a></li>
                                                                <li class="md-mx-none"><a class="quick-view" href="#quick-view" title="Quick View"><i class="flaticon-zoom-increasing-symbol flat-mini"></i></a></li>
                                                        ...
                                                        <div class="post-content py-3">
                                                            <div class="post-meta font-small text-uppercase list-color-general">
                                                                <a href="#" class="listing-ctg"><i class="fa-solid fa-building"></i><span>Condo</span></a>
                                                            </div>
                                                            <h5 class="listing-title"><a href="<?php echo base_url('property-single-v1/');?>">New Developed Condos</a></h5>
                                                            <span class="listing-location"><i class="fas fa-map-marker-alt"></i> 2305 Tree Frog Lane Overlandpk</span>
                                                            <ul class="d-flex quantity font-fifteen">
                                                            ...
                                                            <span class="listing-price">$17500<small>/ Monthly</small></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Property Grid -->
                                                <div class="col mix rent">
                                                    <div class="property-grid-2 property-block transation">
                                                        <div class="overflow-hidden position-relative transation thumbnail-img rounded bg-secondary hover-img-zoom">
                                                            ...
                                                            <a href="<?php echo base_url('property-single-v1/');?>" class="d-block"><img src="<?=base_url();?>assets/images/property_grid/property-grid-8.png" alt="Image Not Found!"></a>
                                                            <ul class="position-absolute quick-meta">
                                                                <li><a href="#" title="Add Compare"><i class="flaticon-transfer flat-mini"></i></a></li>
                                                                <li><a href="#" title="Add Favourite"><i class="flaticon-like-1 flat-mini"></i></a></li>
                                                                <li class="md-mx-none"><a class="quick-view" href="#quick-view" title="Quick View"><i class="flaticon-zoom-increasing-symbol flat-mini"></i></a></li>
                                                        ...
                                                        <div class="post-content py-3">
                                                            ...
                                                            <span class="listing-price">$22500<small>/ Monthly</small></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Property Grid -->
                                                <div class="col mix sale">
                                                    <div class="property-grid-2 property-block transation">
                                                        ...
                                                        <div class="post-content py-3">
                                                            ...
                                                            <span class="listing-price">$12500<small>/ Monthly</small></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Property Grid -->
                                                ...
                                                <div class="col mix rent">
                                                    <div class="property-grid-2 property-block transation">
                                                        <div class="overflow-hidden position-relative transation thumbnail-img rounded bg-secondary hover-img-zoom">
                                                            <div class="cata position-absolute">
                                                                <span class="rent bg-secondary text-white">For Rent</span>
                                                            </div>
                                                            <a href="<?php echo base_url('property-single-v1/');?>"><img src="<?=base_url();?>assets/images/property_grid/property-grid-7.png" alt="Image Not Found!"></a>
                                                            <ul class="position-absolute quick-meta">
                                                                <li><a href="#" title="Add Compare"><i class="flaticon-transfer flat-mini"></i></a></li>
                                                ...
                                                <div class="col mix rent">
                                                    <div class="property-grid-2 property-block transation">
                                                        ...
                                                        <div class="post-content py-3">
                                                            ...
                                                            <span class="listing-price">$22000<small>/ Monthly</small></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                            </div>
                            ...
                            <!-- Comments Form -->
                            <div class="comments-block bg-white p-30 mt-4">
                                <div class="row row-cols-1">
                                    <div class="col">

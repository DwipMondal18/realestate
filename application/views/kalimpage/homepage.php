        ...
        <div class="full-row p-0 overflow-hidden">
            ...
            <div id="slider" class="overflow-hidden" style="width:1200px; height:780px; margin:0 auto;margin-bottom: 0px;">
                ...
                <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:12000; transition2d:104; kenburnsscale:1.00;">
                    <img width="1920" height="960" src="<?=base_url();?>assets/images/slider/1.png" class="ls-bg" alt="" />
                    <p style="font-size:20px; font-weight:400; top:320px; left:50%; font-family: 'Sen', sans-serif;" class="ls-l ls-hide-phone text-white" data-ls="offsetyin:100%; durationin:1500; delayin:500; clipin:0 0 100% 0; durationout:400; parallaxlevel:0;">Real Estate Listing Template</p>
                    <p style="font-size:48px; font-weight:700; top:370px; left:50%; font-family: 'Sen', sans-serif;" class="ls-l ls-hide-phone text-white" data-ls="offsetyin:100%; durationin:1500; delayin:1000; clipin:0 0 100% 0; durationout:400; parallaxlevel:0;">Property Listing Template</p>
                    ...
                    <a style="" class="ls-l ls-hide-phone" href="<?php echo base_url('property-grid-v1/');?>" target="_self" data-ls="offsetyin:40; delayin:2000; clipin:0 0 100% 0; durationout:400; hover:true; hoverdurationin:300; hoveropacity:1; hoverbgcolor:#ffffff; hovercolor:#001244;">
                        <p style="font-weight:500; text-align:center; cursor:pointer; padding-right:35px; padding-left:35px; font-weight: 500; font-size:16px; font-family: 'Sen', sans-serif; line-height:40px; top:550px; left:50%; color: #001244; border-radius:30px; padding-top:10px; padding-bottom:10px; background:#e8e942; white-space:normal;"
                ...
                <!-- Slide 2 -->
                <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:12000; transition2d:104; kenburnsscale:1.00;">
                    <img width="1920" height="960" src="<?=base_url();?>assets/images/slider/2.png" class="ls-bg" alt="" />
                    ...
                    <p style="top:450px; left:50%; text-align:center; font-weight:400; font-style:normal; text-decoration:none; width:650px; font-size:18px; color:#ffffff; line-height:30px; white-space:normal;" class="ls-l ls-hide-phone" data-ls="offsetyin:100%; durationin:1500; delayin:1500; clipin:0 0 100% 0; durationout:400; parallaxlevel:0;">Looking for your dream house or property. Search here and select your best one from more than 1 million listing.</p>
                    <a style="" class="ls-l ls-hide-phone" href="<?php echo base_url('property-grid-v1/');?>" target="_self" data-ls="offsetyin:40; delayin:2000; clipin:0 0 100% 0; durationout:400; hover:true; hoverdurationin:300; hoveropacity:1; hoverbgcolor:#fff; hovercolor:#001244;">
                        <p style="font-weight:500; text-align:center; cursor:pointer; padding-right:35px; padding-left:35px; font-weight: 500; font-size:16px; font-family: 'Sen', sans-serif; line-height:40px; top:550px; left:50%; color:#001244; border-radius:30px; padding-top:10px; padding-bottom:10px; background:#e8e942; white-space:normal;"
                            class="">Preview Listing</p>
                    </a>
                </div>
                ...
                <!-- Slide 3 -->
                <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:12000; transition2d:104; kenburnsscale:1.00;">
                    <img width="1920" height="960" src="<?=base_url();?>assets/images/slider/14.png" class="ls-bg" alt="" />
                    ...
                    <a style="" class="ls-l ls-hide-phone" href="<?php echo base_url('property-grid-v1/');?>" target="_self" data-ls="offsetyin:40; delayin:2000; clipin:0 0 100% 0; durationout:400; hover:true; hoverdurationin:300; hoveropacity:1; hoverbgcolor:#fff; hovercolor:#001244;">
                        <p style="font-weight:500; text-align:center; cursor:pointer; padding-right:35px; padding-left:35px; font-weight: 500; font-size:16px; font-family: 'Sen', sans-serif; line-height:40px; top:550px; left:32px; color:#001244; border-radius:30px; padding-top:10px; padding-bottom:10px; background:#e8e942; white-space:normal;"
                            class="">Preview Listing</p>
                    </a>
                </div>
                    ...
                    <div class="col">
                        <form class="bg-white shadow-sm quick-search form-icon-right position-relative" action="#" method="post">
                            <div class="row row-cols-lg-6 row-cols-md-3 row-cols-1 g-3">
                                ...
                                <div class="col">
                                    <button class="btn btn-primary-new w-100">Search</button>
                                </div>
                                <!-- Advance Features -->
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <h1 class="blue-text mb-0">Our mission is to redefine real estate for the customer's</h1>
                    </div>
                    <div class="col-lg-4">
                        <div class="py-2">
                ...
                <div class="row">
                    <div class="col mb-4">
                        <div class="align-items-center d-flex">
                            ...
                            <a href="<?php echo base_url('property-grid-v1/');?>" class="ms-auto btn-link">View All Properties</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="item">
                                ...
                                <div class="property-grid-1 property-block bg-white transation-this">
                                    ...
                                    <div class="property_text p-4">
                                        ...
                                        <h5 class="listing-title"><a href="<?php echo base_url('property-single-v1/');?>">Luxury Condos Riverside</a></h5>
        ...
        <div class="full-row bg-secondary">
            <div class="container">
                ...
                <div class="row row-cols-lg-5 row-cols-sm-4 row-cols-1 g-3 justify-content-center">
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center p-4 bg-white  transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-home flat-medium d-inline-block  position-absolute xy-center"></i>
                            </div>
                    ...
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-sketch-1 flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                    ...
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-online-booking flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                    ...
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-shop flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                    ...
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-real-estate flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                            <h6 class="d-block text-secondary">Hostel Room</h6>
                            <p>If you are single looking for sinlge living, preview the hostel listing</p>
                        </a>
                    </div>
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center p-4 bg-white transation text-general hover-bg-primary h-100">
                            ...
                            <h6 class="d-block text-secondary">Appartment</h6>
                            <p>For family living appartment, find your best appartment in our directort list</p>
                        </a>
                    </div>
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-sketch flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                            <h6 class="d-block text-secondary">Condo</h6>
                            <p>In our directory we have listed luxury condo for rent and sale</p>
                        </a>
                    </div>
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-spa flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                            <h6 class="d-block text-secondary">Villa House</h6>
                            <p>Please who like villa house click here this category listed</p>
                        </a>
                    </div>
                    <div class="col">
                        <a id ="new-anchor" href="#" class="text-center d-flex flex-column align-items-center  p-4 bg-white transation text-general hover-bg-primary h-100">
                            <div class="box-70px position-relative">
                                <i class="flaticon-bed flat-medium d-inline-block position-absolute xy-center"></i>
                            </div>
                            <h6 class="d-block text-secondary">Hotel Room</h6>
                            <p>The traveller people can find best hotel here for living night</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="align-items-center d-flex">
                            ...
                            <a href="<?php echo base_url('agent-grid-view./');?>" class="ms-auto btn-link">View All Agents</a>
                        </div>
                    </div>
                </div>
                <div class="row row-cols-xl-4 row-cols-md-2 row-cols-1 mt-5">
                    <div class="col">
                        <div class="thumb-team-simple">
                            <img class="rounded-lg" src="<?=base_url();?>assets/images/team/1.jpg" alt="">
                            <div class="user-info d-flex py-4">
                                <div class="me-auto">
                                    <h5 class="text-dark mb-2 font-400"><a href="<?php echo base_url('agent-details');?>">Luann McLawhorn</a></h5>
                    ...
                    <div class="col">
                        <div class="thumb-team-simple">
                            <img class="rounded-lg" src="<?=base_url();?>assets/images/team/2.jpg" alt="">
                            <div class="user-info d-flex py-4">
                                <div class="me-auto">
                                    <h5 class="text-dark mb-2 font-400"><a href="<?php echo base_url('agent-details');?>">Ronald Johnson</a></h5>
                                    <span class="text-secondary font-fifteen">At 1st April, 2012</span>
                                </div>
                    ...
                    <div class="col">
                        <div class="thumb-team-simple">
                            <img class="rounded-lg" src="<?=base_url();?>assets/images/team/3.jpg" alt="">
                            <div class="user-info d-flex py-4">
                                <div class="me-auto">
                                    <h5 class="text-dark mb-2 font-400"><a href="<?php echo base_url('agent-details');?>">John M. Riddle</a></h5>
                                    <span class="text-secondary font-fifteen">At 1st April, 2012</span>
                                </div>
                    ...
                    <div class="col">
                        <div class="thumb-team-simple">
                            <img class="rounded-lg" src="<?=base_url();?>assets/images/team/4.jpg" alt="">
                            <div class="user-info d-flex py-4">
                                <div class="me-auto">
                                    <h5 class="text-dark mb-2 font-400"><a href="<?php echo base_url('agent-details');?>">John M. Riddle</a></h5>
                                    <span class="text-secondary font-fifteen">At 1st April, 2012</span>
            ...
            <div class="container">
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1">
                    <div class="col">
                        <div class="thumb-blog-overlay bg-white hover-text-PushUpBottom mb-4">
                            <div class="post-image position-relative overlay-secondary">
                                <img src="<?=base_url();?>assets/images/blog/1.png" alt="Image not found!">
                    ...
                    <div class="col">
                        <div class="thumb-blog-overlay bg-white hover-text-PushUpBottom mb-4">
                            <div class="post-image position-relative overlay-secondary">
                                <img src="<?=base_url();?>assets/images/blog/2.png" alt="Image not found!">
                                <div class="position-absolute xy-center">
                                    <div class="overflow-hidden text-center">
                                        <a class="text-white first-push-up transation font-large" href="#">+</a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="thumb-blog-overlay bg-white hover-text-PushUpBottom mb-4">
                            <div class="post-image position-relative overlay-secondary">
                                <img src="<?=base_url();?>assets/images/blog/3.png" alt="Image not found!">
                                <div class="position-absolute xy-center">
                                    <div class="overflow-hidden text-center">
                                        <a class="text-white first-push-up transation font-large" href="#">+</a>
                                    </div>
        ...
        <div class="full-row new-bg-cta py-4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <h3 class="text-secondary xs-text-center my-20 font-400">Are you looking for a House or Property Customer?</h3>
                    </div>
                    <div class="col-lg-3 col-md-4">
                        <a  class="btn btn-primary-new y-center position-relative d-table xs-mx-auto ms-auto openPopup">Enquire Now</a>
                    </div>
                </div>
            </div>
        </div>
        <div id="popupForm" class="popup">
            <div class="popup-content">
                <h2>Contact Form</h2>
                <!-- Cross button centered inside the popup-content -->

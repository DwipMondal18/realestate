            ...
            <?php foreach ($use as $user): ?>
                    <tr>
                        <form method="post" action="">
                            <td>
                                <?php if (isset($_POST['edit3']) && $_POST['edit3'] == $user->id): ?>
                            ...
                            <td>
                           <?php if (isset($_POST['edit3']) && $_POST['edit3'] == $user->id): ?>
                                    <button type="submit" name="save3" class="btn btn-primary" value="<?php echo $user->id; ?>">Save</button>
                                <?php else: ?>
                                    <button type="submit" name="edit3" class="edit-button" value="<?php echo $user->id; ?>">Edit</button>
                                <?php endif; ?>
                            </td>
                        </form>
                    </tr>

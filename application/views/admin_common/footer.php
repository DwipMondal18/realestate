    ...
    <!-- Page level plugins -->
    <script src="<?=base_url();?>assets/admin_assets/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?=base_url();?>assets/admin_assets/js/demo/chart-area-demo.js"></script>
    <script src="<?=base_url();?>assets/admin_assets/js/demo/chart-pie-demo.js"></script>
    <script src="<?=base_url();?>assets/admin_assets/js/demo/chart-bar-demo.js"></script>
